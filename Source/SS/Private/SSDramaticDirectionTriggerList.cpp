...
void USSDramaticDirectionTriggerList::OnSelectPanel(USSMenuButton* InButton) {
}

void USSDramaticDirectionTriggerList::OnPanelFocusChange(USSMenuButton* InHitButton) {
}
