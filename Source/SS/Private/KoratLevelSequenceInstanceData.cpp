...
USceneComponent* UKoratLevelSequenceInstanceData::FindTransformOriginComponent(
	AActor* InParentActor, const FName& InComponentName, const FName& InSocketName) const
{
	return NULL;
}
