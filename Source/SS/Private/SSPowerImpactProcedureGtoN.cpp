#include "SSPowerImpactProcedureGtoN.h"

ASSPowerImpactProcedureGtoN::ASSPowerImpactProcedureGtoN(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
