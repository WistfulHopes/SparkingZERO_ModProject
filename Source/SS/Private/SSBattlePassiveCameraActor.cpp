#include "SSBattlePassiveCameraActor.h"

ASSBattlePassiveCameraActor::ASSBattlePassiveCameraActor(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
