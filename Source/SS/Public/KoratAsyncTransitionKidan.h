...
#include "KoratAsyncTransitionKidan.generated.h"

class UKoratAsyncTransitionKidan;
class UObject;

UCLASS(Blueprintable, MinimalAPI)
class UKoratAsyncTransitionKidan : public UBlueprintAsyncActionBase {
    GENERATED_BODY()
public:
    ...
    static UKoratAsyncTransitionKidan* AsyncTransitionKidan(UObject* WorldContextObject, const FKoratReplaceAnimationDataList InAnimDataList);
