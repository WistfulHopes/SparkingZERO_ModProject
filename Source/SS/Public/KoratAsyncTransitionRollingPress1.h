...
#include "KoratAsyncTransitionRollingPress1.generated.h"

class UKoratAsyncTransitionRollingPress1;
class UObject;

UCLASS(Blueprintable, MinimalAPI)
class UKoratAsyncTransitionRollingPress1 : public UBlueprintAsyncActionBase {
    GENERATED_BODY()
public:
    ...
    UKoratAsyncTransitionRollingPress1();
    ...
    static UKoratAsyncTransitionRollingPress1* AsyncTransitionRollingPress1(UObject* WorldContextObject, const FKoratReplaceAnimationDataList InAnimDataList);
