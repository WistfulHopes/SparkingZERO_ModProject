...
#include "KoratAsyncTransitionRushHighSpeedMove.generated.h"

class UKoratAsyncTransitionRushHighSpeedMove;
class UObject;

UCLASS(Blueprintable, MinimalAPI)
class UKoratAsyncTransitionRushHighSpeedMove : public UBlueprintAsyncActionBase {
    GENERATED_BODY()
public:
    ...
    UKoratAsyncTransitionRushHighSpeedMove();
    ...
    static UKoratAsyncTransitionRushHighSpeedMove* AsyncTransitionRushHighSpeedMove(UObject* WorldContextObject, const FKoratReplaceAnimationDataList InAnimDataList);
