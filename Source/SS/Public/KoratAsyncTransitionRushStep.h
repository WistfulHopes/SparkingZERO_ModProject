...
#include "KoratAsyncTransitionRushStep.generated.h"

class UKoratAsyncTransitionRushStep;
class UObject;

UCLASS(Blueprintable, MinimalAPI)
class UKoratAsyncTransitionRushStep : public UBlueprintAsyncActionBase {
    GENERATED_BODY()
public:
    ...
    static UKoratAsyncTransitionRushStep* AsyncTransitionRushStep(UObject* WorldContextObject, const FKoratReplaceAnimationDataList InAnimDataList);
