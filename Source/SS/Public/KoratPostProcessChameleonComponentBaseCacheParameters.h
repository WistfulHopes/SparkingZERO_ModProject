...
#include "KoratPostProcessChameleonComponentBaseCacheParameters.generated.h"
...
struct FKoratPostProcessChameleonComponentBaseCacheParameters {
    GENERATED_BODY()
public:
    ...
    SS_API FKoratPostProcessChameleonComponentBaseCacheParameters();
};
