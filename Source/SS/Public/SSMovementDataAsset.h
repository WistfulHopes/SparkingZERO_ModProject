...
#include "SSMovementDataAsset.generated.h"

class UCurveFloat;
class USSBlownHitWallParamDataAsset;

UCLASS(Blueprintable)
class USSMovementDataAsset : public UMutualDataAsset {
    GENERATED_BODY()
public:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    USSBlownHitWallParamDataAsset* BlownHitWallParamData;
    
    USSMovementDataAsset();
