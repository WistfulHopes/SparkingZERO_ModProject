...
#include "KoratAsyncTransitionBlast.generated.h"

class UKoratAsyncTransitionBlast;
class UObject;

UCLASS(Blueprintable, MinimalAPI)
class UKoratAsyncTransitionBlast : public UBlueprintAsyncActionBase {
    GENERATED_BODY()
public:
    ...
    static UKoratAsyncTransitionBlast* AsyncTransitionBlast(UObject* WorldContextObject, const FKoratReplaceAnimationDataList InAnimDataList);
