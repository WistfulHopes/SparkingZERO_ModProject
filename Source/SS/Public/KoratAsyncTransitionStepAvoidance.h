...
#include "KoratAsyncTransitionStepAvoidance.generated.h"

class UKoratAsyncTransitionStepAvoidance;
class UObject;

UCLASS(Blueprintable, MinimalAPI)
class UKoratAsyncTransitionStepAvoidance : public UBlueprintAsyncActionBase {
    GENERATED_BODY()
public:
    ...
    UKoratAsyncTransitionStepAvoidance();
    ...
    static UKoratAsyncTransitionStepAvoidance* AsyncTransitionStepAvoidance(UObject* WorldContextObject);
