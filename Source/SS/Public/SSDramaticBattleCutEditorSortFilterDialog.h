...
#include "SSDramaticBattleCutEditorSortFilterDialog.generated.h"
...
class USSDramaticBattleCutEditorSortFilterDialog : public USSMenuManager {
    GENERATED_BODY()
public:
protected:
...
public:
    USSDramaticBattleCutEditorSortFilterDialog();
