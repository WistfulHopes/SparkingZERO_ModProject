...
#include "KoratAsyncTransitionParrySmash.generated.h"

class UKoratAsyncTransitionParrySmash;
class UObject;

UCLASS(Blueprintable, MinimalAPI)
class UKoratAsyncTransitionParrySmash : public UBlueprintAsyncActionBase {
    GENERATED_BODY()
public:
    ...
    UKoratAsyncTransitionParrySmash();
    ...
    static UKoratAsyncTransitionParrySmash* AsyncTransitionParrySmash(UObject* WorldContextObject, const FKoratReplaceAnimationDataList InAnimDataList);
