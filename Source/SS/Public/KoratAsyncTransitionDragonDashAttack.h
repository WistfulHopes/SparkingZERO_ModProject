...
#include "KoratAsyncTransitionDragonDashAttack.generated.h"

class UKoratAsyncTransitionDragonDashAttack;
class UObject;

UCLASS(Blueprintable, MinimalAPI)
class UKoratAsyncTransitionDragonDashAttack : public UBlueprintAsyncActionBase {
    GENERATED_BODY()
public:
    ...
    UKoratAsyncTransitionDragonDashAttack();
    ...
    static UKoratAsyncTransitionDragonDashAttack* AsyncTransitionDragonDashAttack(UObject* WorldContextObject, const FKoratReplaceAnimationDataList InAnimDataList);
