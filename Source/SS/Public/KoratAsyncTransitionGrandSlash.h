...
#include "KoratAsyncTransitionGrandSlash.generated.h"

class UKoratAsyncTransitionGrandSlash;
class UObject;

UCLASS(Blueprintable, MinimalAPI)
class UKoratAsyncTransitionGrandSlash : public UBlueprintAsyncActionBase {
    GENERATED_BODY()
public:
    ...
    UKoratAsyncTransitionGrandSlash();
    ...
    static UKoratAsyncTransitionGrandSlash* AsyncTransitionGrandSlash(UObject* WorldContextObject, const FKoratReplaceAnimationDataList InAnimDataList);
