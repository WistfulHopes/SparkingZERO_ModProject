...
#include "SSBlastSKillParamDataAssetRecord.generated.h"

class USSBlastOperationGuideDataAsset;

USTRUCT(BlueprintType)
struct FSSBlastSKillParamDataAssetRecord {
    GENERATED_BODY()
public:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    bool bInterruptibleFrontBarrier;
    ...
    SS_API FSSBlastSKillParamDataAssetRecord();
};
