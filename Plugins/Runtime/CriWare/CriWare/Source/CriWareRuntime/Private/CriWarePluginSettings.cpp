...
UCriWarePluginSettings::UCriWarePluginSettings() {
    ...
    this->NumStandardStreamingVoices = 32;
    ...
    this->AsrRackConfigUI.AddDefaulted(2);
    this->AsrRackConfig.AddDefaulted(2);
    ...
    this->ForceSoftwareDecodingOnXboxSeries = true;
    this->InitializeAdxLipSync = true;
    this->MaxNumAnalyzerHandles = 64;
